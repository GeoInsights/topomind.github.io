(() => {
  const translations = {
    zh: {
      ...
      issacBio: '具備數學碩士背景與 10 年數據分析及數據科學經驗，為 TopoMind 提供香港市場拓展、客戶洞察與數據驅動市場策略方面的顧問支持。',
      contactEyebrow: '開始合作',
    ...
    en: {
      ...
      issacBio: 'An M.Phil. graduate in Mathematics with 10 years of experience in data analysis and data science, Issac advises TopoMind on Hong Kong market development, customer insights and data-driven go-to-market strategy.',
