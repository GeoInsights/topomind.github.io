(() => {
  const translations = {
    zh: {
      ...
      teamEyebrow: '團隊',
      teamTitle: '懂地理、懂數據，也懂產品落地。',
      luweiBio: 'GIS 博士，具備 10 年 GIS 系統開發與空間大數據分析經驗，負責 TopoMind 的空間智能產品方向、地理技術架構與應用研發。',
      issacBio: '數學與數據科學背景，具備 10 年數據分析經驗，協助 TopoMind 拓展香港市場、理解客戶場景與制定數據驅動的落地策略。',
      contactEyebrow: '開始合作',
    ...
    en: {
      ...
      teamEyebrow: 'Team',
      teamTitle: 'Geospatial depth, data expertise and product execution.',
      luweiBio: 'PhD in GIS, with 10 years of experience in GIS system development and spatial big data analysis. He leads TopoMind’s spatial intelligence product direction, geospatial technology architecture and applied R&D.',
      issacBio: 'With a background in mathematics and data science, and 10 years of data analysis experience, he supports TopoMind’s Hong Kong market development, customer insight and data-driven go-to-market strategy.',
  ...
  const setText = (lang) => {
    ...
    if (langToggle) {
      langToggle.textContent = lang === 'zh' ? 'EN' : '繁';
      langToggle.setAttribute('aria-label', lang === 'zh' ? 'Switch to English' : '切換到繁體中文');
    }
  };
